...
- Step 3 `สรุปค่าใช้จ่ายโรงพยาบาล` แสดง `ยอดเงินรวมตามใบเสร็จ` จาก Step 2 และใช้ label `ค่าใช้จ่ายทั้งหมดสุทธิ`; ใช้ร่วมกันใน OPD Full, IPD และ Day Case Surgery
- Step 3 `สรุปค่าชดเชย` ใช้ typography ขนาดอ่านง่ายทั้ง Section; `บัญชีรับเงินค่าชดเชย` และ badge `ผู้ชำระเบี้ยในระบบ` เป็นหัวข้อเด่น ส่วนปุ่ม outline `แก้ไขบัญชี` เปลี่ยนเป็นปุ่มสีเขียว `บันทึกการแก้ไขบัญชี` ระหว่างโหมดแก้ไข
