...
- Customer columns: `เลือกรายการ`, `วันที่แจ้งเคลม`, `วันที่อนุมัติเคลม`, `เลขที่ Case`, `ผู้อนุมัติ`, `จำนวนเงินตั้งเบิก`, `ชื่อบริษัทประกัน`, `ดำเนินการ`; checkbox เลือกตั้งเบิกอยู่ในคอลัมน์แรก และคอลัมน์ดำเนินการใช้สำหรับดูรายละเอียด
...
- รายการเคลมโรงพยาบาลที่อนุมัติจาก `billingHospitalReviewPage` จะถูกย้ายเป็นสถานะ `รอตั้งเบิก` และแสดงในหน้านี้เมื่อเลือกประเภท `เคลมโรงพยาบาล`
