...
- แสดงคำถาม `เป็นอุบัติเหตุจากการจราจร` แบบ Radio `ใช่` / `ไม่ใช่` และเลือก `ไม่ใช่` เป็นค่าเริ่มต้น
- เมื่อเลือก `ใช่` จะแสดงกลุ่มข้อมูลรายละเอียด โดยทุก Radio รายละเอียดยังเริ่มต้นเป็นค่าว่างและผู้ใช้สามารถเลือก/แก้ไขได้
- เมื่อเลือก `ไม่ใช่` จะซ่อนและล้างข้อมูลรายละเอียด และไม่บังคับ Validation ของรายละเอียด
- เมื่อเลือก `ใช่` ให้ Validate รายละเอียดก่อนออกจาก Step 1 หรือกดปุ่มดำเนินการ
...
3. พิจารณาเคลมลูกค้าเลือก `ไม่ใช่` ในคำถามอุบัติเหตุจากการจราจรเป็นค่าเริ่มต้น; เลือก `ใช่` แล้วจึงแสดงรายละเอียดที่แก้ไขได้
