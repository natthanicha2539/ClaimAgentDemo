    ...
    setMarkup(surface, `
      ...
      <section class="cws-card" aria-labelledby="cwsSearchTitle">
        <header class="cws-card-head">
          <div class="cws-card-title"><span class="cws-card-title-icon"><span class="material-icons-round">search</span></span><div><h3 id="cwsSearchTitle">เงื่อนไขการค้นหา</h3></div></div>
        </header>
        <form id="cwsSearchForm" class="cws-card-body" novalidate>
          ...
          <div class="cws-helper-line">
            ...
            <div id="cwsMockOnlyNote" class="cws-mock-note" role="note">
              ...
              <span><strong>หมายเหตุ:</strong> ตัวเลือกส่วนนี้ใช้สำหรับ Mock เพื่อทดสอบเท่านั้น และไม่มีผลต่อการแสดงผลข้อมูล</span>
            </div>
          </div>
        </form>
      </section>
