...
(function () {
  ...
  function isHospitalClaim() {
    return String(currentState().claimCategory || "customer") === "hospital";
  }
  ...
  function isGeneralClaimPaymentPage() {
    ...
    return !!paymentPage && !paymentPage.classList.contains("hidden") && !isExcludedCoverage() && !isHospitalClaim();
  }
